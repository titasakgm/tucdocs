...
# FY and PROJECT-CODE for R and NR is DIFFERENT
# e.g. /opt/tucdocs/XLS/RESEARCH/CEI-RESEARCH_Budget_Plan_FY2018_3rd_revised.xlsx
proj = f.split('_').first.split('/').last
puts "proj: #{proj}"
